...
This repro is a modified version of one example from the [pytorch examples](https://github.com/pytorch/examples/tree/master/fast_neural_style) that was modified to create a model compatible with onnx.js.
