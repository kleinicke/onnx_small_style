...
python neural_style/neural_style.py eval --content-image images/content-images/birds135.jpeg  --model "model/candy123.model" --output-image results/candy135.jpg --cuda 0 --export_onnx model/candy135.onnx